...
<head>
    ...
    <title>MSI H110M Gaming - Shop Item</title>
                        ...
                        <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="item active">
                                    <img class="slide-image" src="/ite220/img/product/mb/H110M_GAMING.jpg" alt="MSI-H110M">
                                </div>
                                <div class="item">
                                    <img class="slide-image" src="/ite220/img/product/mb/MSI-H110M-1.jpg" alt="MSI-H110M-1">
                                </div>
                                <div class="item">
                                    <img class="slide-image" src="/ite220/img/product/mb/MSI-H110M-2.jpg" alt="MSI-H110M-2">
                                </div>
                                <div class="item">
                                    <img class="slide-image" src="/ite220/img/product/mb/MSI-H110M-3.jpg" alt="MSI-H110M-3">
                                </div>
                            </div>
                ...
                <dir class="col-md-8">
                    <div class="caption-full">
                        <form method="post" action="https://www.paypal.com/cgi-bin/webscr">
                            <input type="hidden" name="cmd" value="_cart">
                            <input type="hidden" name="business" value="Store 404">
                            <input type="hidden" name="item_name" value="MSI H110M Gaming">
                        ...
                        <h4 class="pull-right" style="color:green;">฿2,750</h4>
                        <h3>MSI H110M Gaming</h3>
                    </div>
                    <br/>
                    <div class="table-responsive">
                        ...
                        <table class="table table-striped">
                            ...
                            <tr>
                                ...
                                <td>Slot: 2<br/>max: 32GB<br/>Type: Dual Channel DDR4 2133 MHz</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <th>Audio Chip</th>
                                <td>Realtek ALC887 Audio Codec<br/>7.1 Channels HD Audio</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>1 Slot PCIe x16<br/>2 Slot PCIe x1</td>
                            </tr>
                            <tr>
                                <th>Network</th>
                                <td>Intel I219V Gigabit LAN<br/>10/100/1000Mbps</td>
                            </tr>
                            <tr>
                                <th>Rear Panel Ports</th>
                                <td>USB 2.0: 2 Port<br/>Dsub Output: 1 Port<br/>DVI Output: 1 Port<br/>HDMI Output: 1 Port<br/>Audio Output: 3 Port<br/>Port PS2: 2 Port</td>
                            </tr>
                            <tr>
                                <th>Physical Spec</th>
                                <td>Type: Micro-ATX<br/>24+8 Pin<br/>24.3 x 20.6 cm</td>
                            </tr>
                        </table>
                    </div>
                </div>
