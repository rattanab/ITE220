...
<head>
    ...
    <title>Samsung 950 Pro M.2 256GB - Shop Item</title>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="col-md-4">
                    <div class="thumbnail">
                        <img class="img-responsive" src="/ite220/img/product/sd/950-PRO-M2-256GB-256GB.jpg" alt="950-PRO-M2-256GB-256GB">
                    </div>
                </div>
                <dir class="col-md-8">
                    <div class="caption-full">
                        <form method="post" action="https://www.paypal.com/cgi-bin/webscr">
                            <input type="hidden" name="cmd" value="_cart">
                            <input type="hidden" name="business" value="Store 404">
                            <input type="hidden" name="item_name" value="Samsung 950 Pro M.2 256GB">
                            <input type="hidden" name="amount" value="7690">
                        ...
                        <h4 class="pull-right" style="color:green;">฿7,690</h4>
                        <h3>Samsung 950 Pro M.2 256GB</h3>
                    </div>
                    <br/>
                    <div class="table-responsive">
                        ...
                        <table class="table table-striped">
                            ...
                            <tr>
                                <th>MaxRandom 4K</th>
                                <td>Up to 85,000/270,000 IOPS</td>
                            </tr>
                            <tr>
                                <th>Technology</th>
                                <td>Samsung UBX controller</td>
                            </tr>
                            <tr>
