...
<head>
    ...
    <title>Intel i3-7350K - Shop Item</title>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="col-md-4">
                    <div class="thumbnail">
                        <img class="img-responsive" src="/ite220/img/product/cpu/intel_i3k.png" alt="intel i3-7350k">
                    </div>
                </div>
                <dir class="col-md-8">
                    <div class="caption-full">
                        <form method="post" action="https://www.paypal.com/cgi-bin/webscr">
                            ...
                            <input type="hidden" name="amount" value="6900">
                        ...
                        <h4 class="pull-right" style="color:green;">฿6,900</h4>
                        <h3>Intel i3-7350K</h3>
                    </div>
                    <br/>
