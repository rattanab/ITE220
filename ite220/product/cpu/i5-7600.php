...
<head>
    ...
    <title>Intel i5-7600 - Shop Item</title>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="col-md-4">
                    <div class="thumbnail">
                        <img class="img-responsive" src="/ite220/img/product/cpu/intel_i5.jpg" alt="intel i5-7600">
                    </div>
                </div>
                <dir class="col-md-8">
                    <div class="caption-full">
                        <form method="post" action="https://www.paypal.com/cgi-bin/webscr">
                            <input type="hidden" name="cmd" value="_cart">
                            <input type="hidden" name="business" value="Store 404">
                            <input type="hidden" name="item_name" value="Intel Core i5-7600">
                            <input type="hidden" name="amount" value="8750">
                            <input type="hidden" name="currency_code" value="THB">
                            <input type="submit" class="btn btn-success pull-right" name="submit" value="Add to Cart">
                        </form>
                        <h4 class="pull-right" style="color:green;">฿8,750</h4>
                        <h3>Intel i5-7600</h3>
                    </div>
                    <br/>
